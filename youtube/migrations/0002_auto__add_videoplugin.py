...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmsplugin_videoplugin', (
            ...
            ('video', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['youtube.Video'])),
        ))
        db.send_create_signal('youtube', ['VideoPlugin'])
    ...
    models = {
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 10, 0, 0)'}),
        ...
        'youtube.videoplugin': {
            ...
            'video': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['youtube.Video']"})
        }
    }
