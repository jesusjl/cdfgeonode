...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Slide.caption_es'
        db.add_column('slider_slide', 'caption_es',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=400, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Slide.caption_es'
        db.delete_column('slider_slide', 'caption_es')
    ...
    models = {
        ...
        'slider.slide': {
            ...
            'caption_es': ('django.db.models.fields.CharField', [], {'max_length': '400', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
